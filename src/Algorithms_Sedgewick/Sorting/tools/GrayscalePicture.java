...
/**
 * ****************************************************************************
 * Compilation: javac GrayscalePicture.java Execution: java GrayscalePicture
 * imagename Dependencies: none
 *
 ...
 * left
 *
 * - uses BufferedImage.TYPE_INT_RGB because BufferedImage.TYPE_BYTE_GRAY seems
 * to do some undesirable olor correction when calling getRGB() and setRGB()
 *
 *****************************************************************************
 */
 ...
 * by Robert Sedgewick and Kevin Wayne. See {@link Picture} for a version that
 * supports 32-bit RGB color images.
 *
